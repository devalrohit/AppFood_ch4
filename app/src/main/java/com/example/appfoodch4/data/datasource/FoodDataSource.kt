package com.example.appfoodch4.data.datasource
    ...
    override fun getFoodMenu(): List<Food> {
        return mutableListOf(
            ...
            Food(
                name = "Burger",
                price = "Rp.20.000",
                detailfood = "Burger kami disajikan dengan patty daging sapi segar yang dipanggang sempurna, disertai dengan keju leleh, sayuran segar, dan saus spesial, menciptakan pengalaman makan yang memuaskan libero volutpat sagittis. Praesent id feugiat dui. Pellentesque tincidunt, urna non consequat accumsan, lacus enim tristique orci, egestas aliquam neque lectus vel eros. Aliquam sed congue enim. Donec aliquam lorem eu velit tincidunt elementum. Nunc quis eleifend enim. Cras porttitor vulputate finibus. Donec fermentum tincidunt vulputate. Proin euismod nunc in orci tempor, eget rutrum est feugiat. Donec luctus, nibh ut congue dapibus, est purus commodo erat, quis ornare quam enim non justo..",
            ...
            Food(
                name = "Sushi",
                price = "Rp.30.000",
                detailfood = "Sushi kami disiapkan dengan teliti oleh chef berpengalaman menggunakan bahan-bahan segar terbaik. Tiap gigitannya memberikan perpaduan rasa yang unik antara nasi lembut dan isian yang beragam, memberikan pengalaman makan yang memuaskan libero volutpat sagittis. Praesent id feugiat dui. Pellentesque tincidunt, urna non consequat accumsan, lacus enim tristique orci, egestas aliquam neque lectus vel eros. Aliquam sed congue enim. Donec aliquam lorem eu velit tincidunt elementum. Nunc quis eleifend enim. Cras porttitor vulputate finibus. Donec fermentum tincidunt vulputate. Proin euismod nunc in orci tempor, eget rutrum est feugiat. Donec luctus, nibh ut congue dapibus, est purus commodo erat, quis ornare quam enim non justo..",
            ...
            Food(
                name = "Nasi Padang",
                price = "Rp.20.000",
                detailfood = "Nasi Padang kami terkenal dengan ragam hidangan khas Minang yang lezat, seperti rendang, ayam goreng, sambalado, dan gulai cubadak. Setiap suapannya menghadirkan cita rasa yang autentik dan menggugah selera libero volutpat sagittis. Praesent id feugiat dui. Pellentesque tincidunt, urna non consequat accumsan, lacus enim tristique orci, egestas aliquam neque lectus vel eros. Aliquam sed congue enim. Donec aliquam lorem eu velit tincidunt elementum. Nunc quis eleifend enim. Cras porttitor vulputate finibus. Donec fermentum tincidunt vulputate. Proin euismod nunc in orci tempor, eget rutrum est feugiat. Donec luctus, nibh ut congue dapibus, est purus commodo erat, quis ornare quam enim non justo..",
            ...
            Food(
                name = "Bubur Ayam",
                price = "Rp.50.000",
                detailfood = "Bubur ayam kami disajikan dengan ayam suwir yang lembut, telur rebus, bawang goreng, dan kerupuk, disiram dengan kuah kaldu yang gurih. Cocok disantap sebagai sarapan atau camilan di segala waktu libero volutpat sagittis. Praesent id feugiat dui. Pellentesque tincidunt, urna non consequat accumsan, lacus enim tristique orci, egestas aliquam neque lectus vel eros. Aliquam sed congue enim. Donec aliquam lorem eu velit tincidunt elementum. Nunc quis eleifend enim. Cras porttitor vulputate finibus. Donec fermentum tincidunt vulputate. Proin euismod nunc in orci tempor, eget rutrum est feugiat. Donec luctus, nibh ut congue dapibus, est purus commodo erat, quis ornare quam enim non justo..",
